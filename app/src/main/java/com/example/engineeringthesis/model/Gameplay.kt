...
data class Gameplay(
    ...
    override fun toString(): String {
        return "Gameplay(gameplayId=$gameplayId, languageId=$languageId, gameId=$gameId, categoryId=$categoryId, childId=$childId, gameMatchDataStart=$gameMatchDataStart, gameMatchDataEnd=$gameMatchDataEnd)"
    }
}