...
class DragAndDropActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wordsList =  wordViewModel!!.getWordsFromCategory("Sport",1,4)
        val picasso = PicassoClient.getPiccassoInstance(this, OkhttpClient)
        getWordFromList()

        dragAndDropFirstField.visibility
        dragAndDropFirstNameField.setText(wordsList[0].wordName)
        dragAndDropFirstAudio.setOnClickListener()
        {

        }

        dragAndDropSecondField.visibility
        dragAndDropSecondNameField.setText(wordsList[1].wordName)
        dragAndDropSecondAudio.setOnClickListener()
        {

        }

        dragAndDropThirdField.visibility
        dragAndDropThirdNameField.setText(wordsList[2].wordName)
        dragAndDropThirdAudio.setOnClickListener()
        {

        }

        dragAndDropFourField.visibility
        dragAndDropFourNameField.setText(wordsList[3].wordName)
        dragAndDropFourAudio.setOnClickListener()
        {
